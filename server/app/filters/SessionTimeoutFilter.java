...
public class SessionTimeoutFilter extends Filter {
  ...
  public SessionTimeoutFilter(
      Materializer mat, ProfileUtils profileUtils, Provider<SettingsManifest> settingsManifest) {
    super(mat);
  ...
  private Http.Cookie createSessionTimestampCookie(CiviFormProfile profile) {
    ...
    long lastActivityTime = profile.getProfileData().getLastActivityTime() / 1000;
    long sessionStartTime = profile.getProfileData().getSessionStartTime() / 1000;
